        ...
        <div className="flex flex-col items-center justify-between gap-5 pt-8 text-center sm:flex-row sm:text-left">
          <div className="flex flex-col items-center gap-3 zoom-in-bounce delay-200">
            ...
            <div className="flex items-center gap-4">
              {/* X (Twitter) */}
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-slate-300 transition-all hover:scale-110 hover:bg-black hover:text-white" title="X" aria-label="X">
              ...
              {/* Facebook */}
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-slate-300 transition-all hover:scale-110 hover:bg-[#1877F2] hover:text-white" title="Facebook" aria-label="Facebook">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-slate-300 transition-all hover:scale-110 hover:bg-[#FF0000] hover:text-white" title="YouTube" aria-label="YouTube">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-slate-300 transition-all hover:scale-110 hover:bg-[#0A66C2] hover:text-white" title="LinkedIn" aria-label="LinkedIn">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
