        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
          {services.map(({ icon: Icon, titleKey, descKey, iconColor }, i) => (
            <motion.div
              ...
              className="service-card group flex min-h-[280px] cursor-pointer flex-col justify-between border border-[#d9dce5] bg-white p-6 transition-colors duration-300 hover:border-transparent hover:bg-[#0256eb] sm:p-7 md:p-8"
            >
              <div>
              ...
              <a
                href="#faq"
                className="inline-flex w-fit items-center gap-2 text-xs font-bold tracking-wide text-[#073b91] uppercase transition-colors hover:text-[#1259c7] group-hover:text-white"
              >
