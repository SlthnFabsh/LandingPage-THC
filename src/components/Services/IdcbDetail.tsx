...
export default function IdcbDetail() {
  return (
      ...
      <div className="p-6 sm:p-8 lg:p-12">
        ...
        <motion.div {...reveal()} className="border-b border-slate-100 pb-8">
          <div className="flex items-center gap-3 text-brand-600">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight text-blue-900 sm:text-3xl">
                Inter Data Center Backbone (IDCB)
              </h2>
          ...
          <p className="mt-6 text-[15px] sm:text-[16px] leading-[1.9] text-slate-600 font-normal">
            A mission-critical, ultra-high-speed backbone interconnecting primary data centers for
            real-time resource sharing, geo-redundant data replication, and dynamic load balancing.
            Powered by DWDM technology, IDCB delivers secure, scalable, and ultra-low latency
        ...
        <motion.div {...reveal(0.1)} className="mt-8">
          ...
          <img
            src="/assets/images/idcb.webp"
            alt="Inter Data Center Backbone (IDCB) Topology"
