...
const features = [
  'Koneksi privat point to point dan multipoint yang handal',
  'Dedicated network dengan jaringan fiber optik',
  'Jaminan keamanan dan kecepatan untuk aplikasi critical yang One-way Realtime',
  'Memungkinkan Anda meningkatkan kebutuhan bandwidth saat traffic sedang tinggi',
  'Efisiensi biaya bagi perusahaan',
  'Layanan 24/7 oleh tim NOC',
];

export default function IeplDetail() {
      ...
      <div className="p-6 sm:p-8 lg:p-12">
        ...
        <motion.div {...reveal()} className="border-b border-slate-100 pb-8">
          <div className="flex items-center gap-3 text-brand-600">
            ...
            <div>
              ...
              <span className="text-xs font-semibold uppercase tracking-wider text-brand-600">
                Layer-2 Carrier Ethernet Private Line
              </span>
            </div>
          </div>

          <p className="mt-6 text-[15px] sm:text-[16px] leading-[1.9] text-slate-600 font-normal">
            THC IEPL provides private, high-bandwidth point-to-point data communication powered by
            carrier-grade{' '}
            <strong className="font-semibold text-slate-900">Layer 2 Ethernet technology</strong> (Metro
            Ethernet, MPLS), offering flexible scalability with transparent network management.
          </p>
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-3.5 text-center">
              ...
              <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 mt-0.5">Private</p>
            </div>
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-3.5 text-center">
              <span className="text-xl sm:text-2xl font-black text-brand-600">Layer-2</span>
              <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 mt-0.5">Protocol</p>
            </div>
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-3.5 text-center">
              <span className="text-xl sm:text-2xl font-black text-brand-600">MPLS</span>
              <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 mt-0.5">Backed Network</p>
            </div>
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-3.5 text-center">
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Reliable private ethernet connectivity with guaranteed security and performance
              </p>
            </div>
        ...
        {activeSection === 'topology' && (
          ...
          >
            <div>
              <h3 className="text-xl font-bold text-slate-900">
                IEPL Network Topology
              </h3>
              <p className="text-sm text-slate-500 mt-1">
                Visualizing the carrier-grade Layer-2 ethernet private line architecture
              </p>
            </div>

            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/assets/images/topologi_iepl.webp"
              alt="IEPL Network Topology"
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <h4 className="text-lg font-bold text-slate-900">
                Need an IEPL Connection?
              </h4>
              <p className="text-sm text-slate-600 mt-1">
                Consult with our network engineers for scalable bandwidth and custom IEPL provisioning.
              </p>
            </div>
