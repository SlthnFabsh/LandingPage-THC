...
import { Router as RouterIcon, ArrowRight, ShieldCheck } from 'lucide-react';
...
const features = [
  ...
  'Pengelolaan IT oleh pihak Provider',
  'Layanan sesuai kebutuhan perusahaan',
  'Ketersediaan jaringan yang tinggi',
];

export default function ManagedCpeDetail() {
      ...
      <div className="p-6 sm:p-8 lg:p-12">
        ...
        <motion.div {...reveal()} className="border-b border-slate-100 pb-8">
          ...
          <p className="mt-6 text-[15px] sm:text-[16px] leading-[1.9] text-slate-600 font-normal">
            End-to-end network hardware lifecycle management, provisioning enterprise-grade CPE
            routers, firewalls, and access points tailored specifically to your organization&apos;s
            architectural and bandwidth requirements.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Secure, real-time, and fully provider-managed CPE operations
              </p>
            </div>
        ...
        {activeSection === 'support' && (
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Full lifecycle support from provisioning, deployment, to 24/7 operations
              </p>
            </div>

            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/assets/images/cpe.webp"
              alt="Managed CPE Process Support Diagram"
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <h4 className="text-lg font-bold text-slate-900">
                Need Managed CPE Deployment?
              </h4>
              <p className="text-sm text-slate-600 mt-1">
                Consult our NOC engineers for enterprise-grade CPE provisioning and lifecycle management.
              </p>
            </div>
